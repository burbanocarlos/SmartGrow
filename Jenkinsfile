pipeline {
    ...
    stages {
        ...
        stage('Copy local_settings.py') {
            steps {
                configFileProvider([configFile(fileId: '4ba70017-bf34-4252-bcaf-a5474b5b1d39', targetLocation: '/Users/carlosburbano/Documents/2023/Projects/SmartGrow/smartGrowIoT/smartGrowIoT/local_Setting.py')]) {
